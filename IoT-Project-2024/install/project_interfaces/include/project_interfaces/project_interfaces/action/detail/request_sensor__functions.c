...
project_interfaces__action__RequestSensor_Goal__init(project_interfaces__action__RequestSensor_Goal * msg)
{
  ...
  // bs_request
  if (!rosidl_runtime_c__String__init(&msg->bs_request)) {
    project_interfaces__action__RequestSensor_Goal__fini(msg);
    return false;
  }
  return true;
}
...
project_interfaces__action__RequestSensor_Goal__fini(project_interfaces__action__RequestSensor_Goal * msg)
{
  ...
  // bs_request
  rosidl_runtime_c__String__fini(&msg->bs_request);
}
  ...
  project_interfaces__action__RequestSensor_Goal * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->bs_request), &(output->bs_request)))
  {
    return false;
  }
  return true;
...
project_interfaces__action__RequestSensor_Goal__create()
{
  ...
  project_interfaces__action__RequestSensor_Goal * msg = (project_interfaces__action__RequestSensor_Goal *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project_interfaces__action__RequestSensor_Goal));
  bool success = project_interfaces__action__RequestSensor_Goal__init(msg);
  if (!success) {
...
project_interfaces__action__RequestSensor_Goal__Sequence__init(project_interfaces__action__RequestSensor_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_Goal * data = NULL;

  if (size) {
    data = (project_interfaces__action__RequestSensor_Goal *)allocator.zero_allocate(size, sizeof(project_interfaces__action__RequestSensor_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project_interfaces__action__RequestSensor_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        project_interfaces__action__RequestSensor_Goal__fini(&data[i - 1]);
      }
...
project_interfaces__action__RequestSensor_Goal__Sequence__fini(project_interfaces__action__RequestSensor_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      project_interfaces__action__RequestSensor_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_Goal__Sequence * array = (project_interfaces__action__RequestSensor_Goal__Sequence *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project_interfaces__action__RequestSensor_Goal__Sequence__init(array, size);
  if (!success) {
...
project_interfaces__action__RequestSensor_Goal__Sequence__destroy(project_interfaces__action__RequestSensor_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project_interfaces__action__RequestSensor_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project_interfaces__action__RequestSensor_Goal__Sequence__are_equal(const project_interfaces__action__RequestSensor_Goal__Sequence * lhs, const project_interfaces__action__RequestSensor_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project_interfaces__action__RequestSensor_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project_interfaces__action__RequestSensor_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project_interfaces__action__RequestSensor_Goal * data =
      (project_interfaces__action__RequestSensor_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project_interfaces__action__RequestSensor_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project_interfaces__action__RequestSensor_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!project_interfaces__action__RequestSensor_Goal__copy(
...
project_interfaces__action__RequestSensor_Result__init(project_interfaces__action__RequestSensor_Result * msg)
{
  ...
  // balloons_response
  if (!rosidl_runtime_c__String__init(&msg->balloons_response)) {
    project_interfaces__action__RequestSensor_Result__fini(msg);
    return false;
  }
  return true;
}
...
project_interfaces__action__RequestSensor_Result__fini(project_interfaces__action__RequestSensor_Result * msg)
{
  ...
  // balloons_response
  rosidl_runtime_c__String__fini(&msg->balloons_response);
}
...
project_interfaces__action__RequestSensor_Result__are_equal(const project_interfaces__action__RequestSensor_Result * lhs, const project_interfaces__action__RequestSensor_Result * rhs)
{
  ...
  // balloons_response
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->balloons_response), &(rhs->balloons_response)))
  {
    return false;
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_Result * output)
{
  ...
  // balloons_response
  if (!rosidl_runtime_c__String__copy(
      &(input->balloons_response), &(output->balloons_response)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_Result * msg = (project_interfaces__action__RequestSensor_Result *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project_interfaces__action__RequestSensor_Result));
  bool success = project_interfaces__action__RequestSensor_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_Result__Sequence__init(project_interfaces__action__RequestSensor_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_Result * data = NULL;

  if (size) {
    data = (project_interfaces__action__RequestSensor_Result *)allocator.zero_allocate(size, sizeof(project_interfaces__action__RequestSensor_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project_interfaces__action__RequestSensor_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        project_interfaces__action__RequestSensor_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
project_interfaces__action__RequestSensor_Result__Sequence__fini(project_interfaces__action__RequestSensor_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      project_interfaces__action__RequestSensor_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_Result__Sequence * array = (project_interfaces__action__RequestSensor_Result__Sequence *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project_interfaces__action__RequestSensor_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_Result__Sequence__destroy(project_interfaces__action__RequestSensor_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project_interfaces__action__RequestSensor_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project_interfaces__action__RequestSensor_Result__Sequence__are_equal(const project_interfaces__action__RequestSensor_Result__Sequence * lhs, const project_interfaces__action__RequestSensor_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project_interfaces__action__RequestSensor_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project_interfaces__action__RequestSensor_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project_interfaces__action__RequestSensor_Result * data =
      (project_interfaces__action__RequestSensor_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project_interfaces__action__RequestSensor_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project_interfaces__action__RequestSensor_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!project_interfaces__action__RequestSensor_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
project_interfaces__action__RequestSensor_Feedback__init(project_interfaces__action__RequestSensor_Feedback * msg)
{
  ...
  // feed
  if (!rosidl_runtime_c__String__init(&msg->feed)) {
    project_interfaces__action__RequestSensor_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
project_interfaces__action__RequestSensor_Feedback__fini(project_interfaces__action__RequestSensor_Feedback * msg)
{
  ...
  // feed
  rosidl_runtime_c__String__fini(&msg->feed);
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_Feedback * msg = (project_interfaces__action__RequestSensor_Feedback *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project_interfaces__action__RequestSensor_Feedback));
  bool success = project_interfaces__action__RequestSensor_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_Feedback__Sequence__init(project_interfaces__action__RequestSensor_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_Feedback * data = NULL;

  if (size) {
    data = (project_interfaces__action__RequestSensor_Feedback *)allocator.zero_allocate(size, sizeof(project_interfaces__action__RequestSensor_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project_interfaces__action__RequestSensor_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        project_interfaces__action__RequestSensor_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
project_interfaces__action__RequestSensor_Feedback__Sequence__fini(project_interfaces__action__RequestSensor_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      project_interfaces__action__RequestSensor_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_Feedback__Sequence * array = (project_interfaces__action__RequestSensor_Feedback__Sequence *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project_interfaces__action__RequestSensor_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_Feedback__Sequence__destroy(project_interfaces__action__RequestSensor_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project_interfaces__action__RequestSensor_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project_interfaces__action__RequestSensor_Feedback__Sequence__are_equal(const project_interfaces__action__RequestSensor_Feedback__Sequence * lhs, const project_interfaces__action__RequestSensor_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project_interfaces__action__RequestSensor_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project_interfaces__action__RequestSensor_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project_interfaces__action__RequestSensor_Feedback * data =
      (project_interfaces__action__RequestSensor_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project_interfaces__action__RequestSensor_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project_interfaces__action__RequestSensor_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!project_interfaces__action__RequestSensor_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
project_interfaces__action__RequestSensor_SendGoal_Request__init(project_interfaces__action__RequestSensor_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    project_interfaces__action__RequestSensor_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!project_interfaces__action__RequestSensor_Goal__init(&msg->goal)) {
    project_interfaces__action__RequestSensor_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
project_interfaces__action__RequestSensor_SendGoal_Request__fini(project_interfaces__action__RequestSensor_SendGoal_Request * msg)
{
  ...
  // goal
  project_interfaces__action__RequestSensor_Goal__fini(&msg->goal);
}
...
project_interfaces__action__RequestSensor_SendGoal_Request__are_equal(const project_interfaces__action__RequestSensor_SendGoal_Request * lhs, const project_interfaces__action__RequestSensor_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!project_interfaces__action__RequestSensor_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_SendGoal_Request * msg = (project_interfaces__action__RequestSensor_SendGoal_Request *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project_interfaces__action__RequestSensor_SendGoal_Request));
  bool success = project_interfaces__action__RequestSensor_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_SendGoal_Request__Sequence__init(project_interfaces__action__RequestSensor_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_SendGoal_Request * data = NULL;

  if (size) {
    data = (project_interfaces__action__RequestSensor_SendGoal_Request *)allocator.zero_allocate(size, sizeof(project_interfaces__action__RequestSensor_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project_interfaces__action__RequestSensor_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        project_interfaces__action__RequestSensor_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
project_interfaces__action__RequestSensor_SendGoal_Request__Sequence__fini(project_interfaces__action__RequestSensor_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      project_interfaces__action__RequestSensor_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_SendGoal_Request__Sequence * array = (project_interfaces__action__RequestSensor_SendGoal_Request__Sequence *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project_interfaces__action__RequestSensor_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_SendGoal_Request__Sequence__destroy(project_interfaces__action__RequestSensor_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project_interfaces__action__RequestSensor_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project_interfaces__action__RequestSensor_SendGoal_Request__Sequence__are_equal(const project_interfaces__action__RequestSensor_SendGoal_Request__Sequence * lhs, const project_interfaces__action__RequestSensor_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project_interfaces__action__RequestSensor_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project_interfaces__action__RequestSensor_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project_interfaces__action__RequestSensor_SendGoal_Request * data =
      (project_interfaces__action__RequestSensor_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project_interfaces__action__RequestSensor_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project_interfaces__action__RequestSensor_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!project_interfaces__action__RequestSensor_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
project_interfaces__action__RequestSensor_SendGoal_Response__init(project_interfaces__action__RequestSensor_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    project_interfaces__action__RequestSensor_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_SendGoal_Response * msg = (project_interfaces__action__RequestSensor_SendGoal_Response *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project_interfaces__action__RequestSensor_SendGoal_Response));
  bool success = project_interfaces__action__RequestSensor_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_SendGoal_Response__Sequence__init(project_interfaces__action__RequestSensor_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_SendGoal_Response * data = NULL;

  if (size) {
    data = (project_interfaces__action__RequestSensor_SendGoal_Response *)allocator.zero_allocate(size, sizeof(project_interfaces__action__RequestSensor_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project_interfaces__action__RequestSensor_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        project_interfaces__action__RequestSensor_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
project_interfaces__action__RequestSensor_SendGoal_Response__Sequence__fini(project_interfaces__action__RequestSensor_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      project_interfaces__action__RequestSensor_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_SendGoal_Response__Sequence * array = (project_interfaces__action__RequestSensor_SendGoal_Response__Sequence *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project_interfaces__action__RequestSensor_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_SendGoal_Response__Sequence__destroy(project_interfaces__action__RequestSensor_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project_interfaces__action__RequestSensor_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project_interfaces__action__RequestSensor_SendGoal_Response__Sequence__are_equal(const project_interfaces__action__RequestSensor_SendGoal_Response__Sequence * lhs, const project_interfaces__action__RequestSensor_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project_interfaces__action__RequestSensor_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project_interfaces__action__RequestSensor_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project_interfaces__action__RequestSensor_SendGoal_Response * data =
      (project_interfaces__action__RequestSensor_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project_interfaces__action__RequestSensor_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project_interfaces__action__RequestSensor_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!project_interfaces__action__RequestSensor_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
project_interfaces__action__RequestSensor_GetResult_Request__init(project_interfaces__action__RequestSensor_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    project_interfaces__action__RequestSensor_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_GetResult_Request * msg = (project_interfaces__action__RequestSensor_GetResult_Request *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project_interfaces__action__RequestSensor_GetResult_Request));
  bool success = project_interfaces__action__RequestSensor_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_GetResult_Request__Sequence__init(project_interfaces__action__RequestSensor_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_GetResult_Request * data = NULL;

  if (size) {
    data = (project_interfaces__action__RequestSensor_GetResult_Request *)allocator.zero_allocate(size, sizeof(project_interfaces__action__RequestSensor_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project_interfaces__action__RequestSensor_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        project_interfaces__action__RequestSensor_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
project_interfaces__action__RequestSensor_GetResult_Request__Sequence__fini(project_interfaces__action__RequestSensor_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      project_interfaces__action__RequestSensor_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_GetResult_Request__Sequence * array = (project_interfaces__action__RequestSensor_GetResult_Request__Sequence *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project_interfaces__action__RequestSensor_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_GetResult_Request__Sequence__destroy(project_interfaces__action__RequestSensor_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project_interfaces__action__RequestSensor_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project_interfaces__action__RequestSensor_GetResult_Request__Sequence__are_equal(const project_interfaces__action__RequestSensor_GetResult_Request__Sequence * lhs, const project_interfaces__action__RequestSensor_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project_interfaces__action__RequestSensor_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project_interfaces__action__RequestSensor_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project_interfaces__action__RequestSensor_GetResult_Request * data =
      (project_interfaces__action__RequestSensor_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project_interfaces__action__RequestSensor_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project_interfaces__action__RequestSensor_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!project_interfaces__action__RequestSensor_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
project_interfaces__action__RequestSensor_GetResult_Response__init(project_interfaces__action__RequestSensor_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!project_interfaces__action__RequestSensor_Result__init(&msg->result)) {
    project_interfaces__action__RequestSensor_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
project_interfaces__action__RequestSensor_GetResult_Response__fini(project_interfaces__action__RequestSensor_GetResult_Response * msg)
{
  ...
  // status
  // result
  project_interfaces__action__RequestSensor_Result__fini(&msg->result);
}
...
project_interfaces__action__RequestSensor_GetResult_Response__are_equal(const project_interfaces__action__RequestSensor_GetResult_Response * lhs, const project_interfaces__action__RequestSensor_GetResult_Response * rhs)
{
  ...
  // result
  if (!project_interfaces__action__RequestSensor_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_GetResult_Response * msg = (project_interfaces__action__RequestSensor_GetResult_Response *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project_interfaces__action__RequestSensor_GetResult_Response));
  bool success = project_interfaces__action__RequestSensor_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_GetResult_Response__Sequence__init(project_interfaces__action__RequestSensor_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_GetResult_Response * data = NULL;

  if (size) {
    data = (project_interfaces__action__RequestSensor_GetResult_Response *)allocator.zero_allocate(size, sizeof(project_interfaces__action__RequestSensor_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project_interfaces__action__RequestSensor_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        project_interfaces__action__RequestSensor_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
project_interfaces__action__RequestSensor_GetResult_Response__Sequence__fini(project_interfaces__action__RequestSensor_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      project_interfaces__action__RequestSensor_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_GetResult_Response__Sequence * array = (project_interfaces__action__RequestSensor_GetResult_Response__Sequence *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project_interfaces__action__RequestSensor_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_GetResult_Response__Sequence__destroy(project_interfaces__action__RequestSensor_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project_interfaces__action__RequestSensor_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project_interfaces__action__RequestSensor_GetResult_Response__Sequence__are_equal(const project_interfaces__action__RequestSensor_GetResult_Response__Sequence * lhs, const project_interfaces__action__RequestSensor_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project_interfaces__action__RequestSensor_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project_interfaces__action__RequestSensor_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project_interfaces__action__RequestSensor_GetResult_Response * data =
      (project_interfaces__action__RequestSensor_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project_interfaces__action__RequestSensor_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project_interfaces__action__RequestSensor_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!project_interfaces__action__RequestSensor_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
project_interfaces__action__RequestSensor_FeedbackMessage__init(project_interfaces__action__RequestSensor_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    project_interfaces__action__RequestSensor_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!project_interfaces__action__RequestSensor_Feedback__init(&msg->feedback)) {
    project_interfaces__action__RequestSensor_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
project_interfaces__action__RequestSensor_FeedbackMessage__fini(project_interfaces__action__RequestSensor_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  project_interfaces__action__RequestSensor_Feedback__fini(&msg->feedback);
}
...
project_interfaces__action__RequestSensor_FeedbackMessage__are_equal(const project_interfaces__action__RequestSensor_FeedbackMessage * lhs, const project_interfaces__action__RequestSensor_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!project_interfaces__action__RequestSensor_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_FeedbackMessage * msg = (project_interfaces__action__RequestSensor_FeedbackMessage *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(project_interfaces__action__RequestSensor_FeedbackMessage));
  bool success = project_interfaces__action__RequestSensor_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_FeedbackMessage__Sequence__init(project_interfaces__action__RequestSensor_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_FeedbackMessage * data = NULL;

  if (size) {
    data = (project_interfaces__action__RequestSensor_FeedbackMessage *)allocator.zero_allocate(size, sizeof(project_interfaces__action__RequestSensor_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = project_interfaces__action__RequestSensor_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        project_interfaces__action__RequestSensor_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
project_interfaces__action__RequestSensor_FeedbackMessage__Sequence__fini(project_interfaces__action__RequestSensor_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      project_interfaces__action__RequestSensor_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  project_interfaces__action__RequestSensor_FeedbackMessage__Sequence * array = (project_interfaces__action__RequestSensor_FeedbackMessage__Sequence *)allocator.allocate(sizeof(project_interfaces__action__RequestSensor_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = project_interfaces__action__RequestSensor_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
project_interfaces__action__RequestSensor_FeedbackMessage__Sequence__destroy(project_interfaces__action__RequestSensor_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    project_interfaces__action__RequestSensor_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
project_interfaces__action__RequestSensor_FeedbackMessage__Sequence__are_equal(const project_interfaces__action__RequestSensor_FeedbackMessage__Sequence * lhs, const project_interfaces__action__RequestSensor_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!project_interfaces__action__RequestSensor_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  project_interfaces__action__RequestSensor_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(project_interfaces__action__RequestSensor_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    project_interfaces__action__RequestSensor_FeedbackMessage * data =
      (project_interfaces__action__RequestSensor_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!project_interfaces__action__RequestSensor_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          project_interfaces__action__RequestSensor_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!project_interfaces__action__RequestSensor_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
