...
#include "project_interfaces/action/detail/patrol__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const project_interfaces::action::Patrol_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<project_interfaces::action::Patrol_Goal *>(
    untyped_ros_message);
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_Goal)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_project_interfaces
cdr_serialize(
  const project_interfaces::action::Patrol_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::action::Patrol_Result & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = project_interfaces::action::Patrol_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const project_interfaces::action::Patrol_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<project_interfaces::action::Patrol_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_Result)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_project_interfaces
cdr_serialize(
  const project_interfaces::action::Patrol_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: feedback
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::action::Patrol_Feedback & ros_message)
{
  // Member: feedback
  cdr >> ros_message.feedback;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = project_interfaces::action::Patrol_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const project_interfaces::action::Patrol_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<project_interfaces::action::Patrol_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_Feedback)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_Feedback__handle;
}
...
// functions for project_interfaces::action::Patrol_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_project_interfaces
cdr_serialize(
  const project_interfaces::action::Patrol_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::action::Patrol_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        project_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Patrol_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = project_interfaces::action::Patrol_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const project_interfaces::action::Patrol_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<project_interfaces::action::Patrol_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_SendGoal_Request)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_project_interfaces
cdr_serialize(
  const project_interfaces::action::Patrol_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::action::Patrol_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = project_interfaces::action::Patrol_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const project_interfaces::action::Patrol_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<project_interfaces::action::Patrol_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_SendGoal_Response)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_SendGoal_Response__handle;
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_SendGoal)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_project_interfaces
cdr_serialize(
  const project_interfaces::action::Patrol_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::action::Patrol_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = project_interfaces::action::Patrol_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const project_interfaces::action::Patrol_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<project_interfaces::action::Patrol_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_GetResult_Request)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for project_interfaces::action::Patrol_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_project_interfaces
cdr_serialize(
  const project_interfaces::action::Patrol_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::action::Patrol_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        project_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Patrol_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = project_interfaces::action::Patrol_GetResult_Response;
    is_plain =
      (
      offsetof(DataType, result) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const project_interfaces::action::Patrol_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<project_interfaces::action::Patrol_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_GetResult_Response)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_GetResult_Response__handle;
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_GetResult)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_GetResult__handle;
}
...
// functions for project_interfaces::action::Patrol_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_project_interfaces
cdr_serialize(
  const project_interfaces::action::Patrol_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::action::Patrol_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        project_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Patrol_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = project_interfaces::action::Patrol_FeedbackMessage;
    is_plain =
      (
      offsetof(DataType, feedback) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const project_interfaces::action::Patrol_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<project_interfaces::action::Patrol_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, action, Patrol_FeedbackMessage)() {
  return &project_interfaces::action::typesupport_fastrtps_cpp::_Patrol_FeedbackMessage__handle;
}
